...
(function dartProgram() {
  ...
  A = {
    ...
    _StringStream$(_data) {
      ...
      t1.addEntries$1(B.Map_Am4V8.get$entries().map$1$1(0, new A._StringStream__goalToEventCode_closure(), type$.MapEntry_int_String));
    ...
    _ControllerSubscription$(_controller, onData, onError, onDone, cancelOnError) {
      var t5,
        ...
        t4 = A._BufferingStreamSubscription__registerDataHandler(t1, onData);
      A._BufferingStreamSubscription__registerErrorHandler(t1, onError);
      t5 = onDone == null ? A.async___nullDoneHandler$closure() : onDone;
      return new A._ControllerSubscription(_controller, t4, t5, t1, t2 | t3);
    },
    ...
    _DoneStreamSubscription$(onDone) {
      var t1 = new A._DoneStreamSubscription($.Zone__current);
    ...
    LinkedHashMap_LinkedHashMap$from(other, $K, $V) {
      ...
      other._collection$_map.forEach$1(0, new A.LinkedHashMap_LinkedHashMap$from_closure(result, $K, $V));
      return result;
    },
    ...
    main0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$currentError, loginResponse, e, exception, apiService, $async$exception;
      var $async$main0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              apiService = new A.ApiService("https://barbermanager-back-end.onrender.com");
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait(apiService.login$2("test@example.com", "password123"), $async$main0);
            case 6:
              // returning from await.
              loginResponse = $async$result;
              A.print("POST /login:");
              A.print(loginResponse);
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
    ...
    ApiService: function ApiService(t0) {
      this.baseUrl = t0;
    },
  ...
  A._canvasKitJsUrls_closure.prototype = {
    call$1(filename) {
      ...
      return (t1 == null ? "https://www.gstatic.com/flutter-canvaskit/36335019a8eab588c3c2ea783c618d90505be233/" : t1) + filename;
    },
    $signature: 8
  };
  ...
  A._BroadcastStreamController.prototype = {
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      A._BufferingStreamSubscription__registerErrorHandler(t1, onError);
      t5 = onDone == null ? A.async___nullDoneHandler$closure() : onDone;
      subscription = new A._BroadcastSubscription(_this, t4, t5, t1, t2 | t3, A._instanceType(_this)._eval$1("_BroadcastSubscription<1>"));
      subscription._async$_previous = subscription;
      subscription._async$_next = subscription;
  ...
  A._StreamController.prototype = {
    ...
    _add$1(value) {
      var t1 = this._state;
      if ((t1 & 1) !== 0)
        this.get$_subscription()._addPending$1(new A._DelayedData(value));
      else if ((t1 & 3) === 0)
  ...
  A._UnicodeSubsetEncoderSink.prototype = {
    ...
    addSlice$4(source, start, end, isLast) {
      var t1, i, codeUnit, listLength, t2, t3;
      ...
      t1 = A.List_List$from(t1.getRange$2(t1, start, end), true, type$.CodeUnits._eval$1("ListBase.E"));
      t2 = this._sink._sink;
      t3 = t2._stringSink;
      t3._contents += t1;
      if (isLast)
  ...
  A._UnicodeSubsetDecoder.prototype = {
    convert$1(bytes) {
      var t1, i, byte,
        end = A.RangeError_checkValidRange(0, null, bytes.length);
      for (t1 = ~this._subsetMask, i = 0; i < end; ++i) {
        byte = bytes[i];
        if ((byte & t1) !== 0) {
  ...
  A.AsciiDecoder.prototype = {
    startChunkedConversion$1(sink) {
      if (this._allowInvalid)
        return new A._ErrorHandlingAsciiDecoderSink(sink.asUtf8Sink$1(false));
      else
        return new A._SimpleAsciiDecoderSink(sink);
    }
  };
  ...
  A.Latin1Decoder.prototype = {
    startChunkedConversion$1(sink) {
      if (!this._allowInvalid)
        return new A._Latin1DecoderSink(sink);
  ...
  A.ApiService.prototype = {
    post$2(endpoint, body) {
      return this.post$body$ApiService(endpoint, body);
    },
    post$body$ApiService(endpoint, body) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, response, e, t1, exception, url, $async$exception;
      var $async$post$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              url = A.Uri_parse($async$self.baseUrl + endpoint);
              $async$handler = 4;
              t1 = type$.String;
              t1 = A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json"], t1, t1);
              $async$goto = 7;
              return A._asyncAwait(A.post(url, B.C_JsonCodec.encode$2$toEncodable(body, null), t1), $async$post$2);
            case 7:
              // returning from await.
              response = $async$result;
              t1 = $async$self._processResponse$1(response);
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
            ...
            case 4:
              ...
              $async$exception = $async$currentError;
              e = A.unwrapException($async$exception);
              t1 = A.Exception_Exception("Failed to POST data: " + A.S(e));
              throw A.wrapException(t1);
              // goto after finally
              $async$goto = 6;
              break;
    ...
    login$2(email, password) {
      return this.login$body$ApiService(email, password);
    },
    login$body$ApiService(email, password) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$self = this, t1;
      var $async$login$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.String;
              $async$goto = 3;
              return A._asyncAwait($async$self.post$2("/login", A.LinkedHashMap_LinkedHashMap$_literal(["email", email, "password", password], t1, t1)), $async$login$2);
            case 3:
              // returning from await.
      ...
      return A._asyncStartSync($async$login$2, $async$completer);
    },
    _processResponse$1(response) {
      var t1 = response.statusCode;
      if (t1 >= 200 && t1 < 300)
        return B.C_JsonCodec.decode$2$reviver(A.encodingForCharset(A._contentTypeForHeaders(response.headers).parameters._collection$_map.$index(0, "charset")).decode$1(response.bodyBytes), null);
      else
        throw A.wrapException(A.Exception_Exception("Error: " + t1 + " - " + response.get$body()));
    }
  };
  ...
  A.BrowserClient.prototype = {
    ...
    close$0() {
      var t1, t2, t3, t4;
      this._isClosed = true;
      for (t1 = this._xhrs, t2 = A._LinkedHashSetIterator$(t1, t1._collection$_modifications, t1.$ti._precomputed1), t3 = t2.$ti._precomputed1; t2.moveNext$0();) {
  ...
  A.ByteStream_toBytes_closure.prototype = {
    call$1(bytes) {
      return this.completer.complete$1(new Uint8Array(A._ensureNativeList(bytes)));
    },
    $signature: 85
  };
  ...
  A.Highlighter__collateLines_closure1.prototype = {
    call$1(entry) {
      ...
      for (t2 = lines.length, highlightIndex = 0, _i = 0; _i < lines.length; lines.length === t2 || (0, A.throwConcurrentModificationError)(lines), ++_i) {
        ...
        for (t3 = t1.skip$1(highlightsForFile, highlightIndex), t4 = t3.$ti, t3 = new A.ListIterator(t3, t3.get$length(0), t4._eval$1("ListIterator<ListIterable.E>")), t4 = t4._eval$1("ListIterable.E"); t3.moveNext$0();) {
          t5 = t3.__internal$_current;
          if (t5 == null)
            t5 = t4._as(t5);
          if (t5.span.get$start().get$line() > line.number)
            break;
          activeHighlights.push(t5);
        }
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "_engine___noopCallback$closure", "_noopCallback", 10);
    ...
    _instance_1_u(A.KeyboardBinding.prototype, "get$_onKeyData", "_onKeyData$1", 18);
    ...
    _instance_1_u(_, "get$_setAppLifecycleState", "_setAppLifecycleState$1", 39);
    _instance_1_u(_, "get$_updateHighContrast", "_updateHighContrast$1", 19);
    ...
    _instance_1_u(A.FlutterViewManager.prototype, "get$disposeAndUnregisterView", "disposeAndUnregisterView$1", 15);
    ...
    _static_1(A, "convert___defaultToEncodable$closure", "_defaultToEncodable", 28);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.createDomResizeObserver_closure, A.initializeEngineServices_closure, A.futureToPromise_closure, A.KeyboardConverter__handleEvent_closure2, A.KeyboardConverter__handleEvent__closure, A.EnginePlatformDispatcher__addFontSizeObserver_closure, A.CustomElementDimensionsProvider_closure0, A._CastListBase_sort_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A.Future_wait_handleError, A._Future__chainForeignFuture_closure0, A._RootZone_bindBinaryCallback_closure, A.LinkedHashMap_LinkedHashMap$from_closure, A.MapBase_mapToString_closure, A._JsonStringifier_writeMap_closure, A.Uri__parseIPv4Address_error, A.Uri_parseIPv6Address_error, A.Uri_parseIPv6Address_parseHex, A._createTables_build, A.CanonicalizedMap_addAll_closure, A.CanonicalizedMap_forEach_closure, A.BaseRequest_closure, A.MediaType_toString_closure, A.Highlighter__collateLines_closure0]);
    _inheritMany(A.Iterable, [A._DomListWrapper, A._DomTouchListWrapper, A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.ExpandIterable, A.SkipIterable, A.WhereTypeIterable, A._KeysOrValues, A._AllMatchesIterable, A._StringAllMatchesIterable, A._SyncStarIterable]);
    ...
    _inheritMany(A.Stream, [A._StreamImpl, A.StreamView, A._EmptyStream, A._EventStream]);
    ...
    _inheritMany(A.StringConversionSink, [A._StringSinkConversionSink, A._UnicodeSubsetEncoderSink]);
    ...
    _inheritMany(A.Converter, [A._UnicodeSubsetEncoder, A._UnicodeSubsetDecoder, A.Base64Encoder, A._FusedConverter, A.JsonEncoder, A.JsonDecoder, A.Utf8Encoder, A.Utf8Decoder]);
    ...
    _inheritMany(A.ByteConversionSink, [A._ErrorHandlingAsciiDecoderSink, A._SimpleAsciiDecoderSink, A._Base64EncoderSink, A._ByteAdapterSink, A._ByteCallbackSink, A._Latin1DecoderSink, A._Utf8StringSinkAdapter]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(JavaScriptObject)", "bool(FlutterHtmlKeyboardEvent)", "Null()", "~(int)", "~(@)", "Null(JavaScriptObject)", "~(~())", "String(String)", "int()", "~(ByteData?)", "~(Object,StackTrace)", "bool(_Highlight)", "String(Match)", "~(Object?)", "JavaScriptObject?(int)", "Future<~>()", "JSObject([JavaScriptObject?])", "bool(KeyData)", "~(bool)", "KeyData()", "bool(String)", "Null(JSObject)", "~(Uint8List,String,int)", "bool(Object?,Object?)", "@()", "int(Object?)", "Null(@)", "@(@)", "~(Object?,Object?)", "List<JavaScriptObject>()", "Future<Null>()", "int(@,@)", "Future<JavaScriptObject>([JavaScriptObject?])", "~(JSObject)", "Null(~)", "~(int,bool(FlutterHtmlKeyboardEvent))", "bool(int,int)", "~(ViewFocusEvent)", "~(AppLifecycleState)", "~(JSArray<Object?>,JavaScriptObject)", "Future<JavaScriptObject>()", "RegisteredFont?(ByteBuffer,String,String)", "~(JavaScriptObject,List<PointerData>)", "~({allowPlatformDefault:bool})", "_ButtonSanitizer()", "MultiSurfaceViewRasterizer()", "_PointerDeviceState()", "DateTime()", "bool(SemanticsObject)", "~(double)", "~(List<JavaScriptObject>,JavaScriptObject)", "Null(Object?)", "~(Size?)", "Null(JavaScriptFunction,JavaScriptFunction)", "@(@,String)", "@(String)", "MapEntry<int,String>(MapEntry<String,String>)", "JSObject()", "Null(~())", "Surface()", "Null(@,StackTrace)", "~(int,@)", "OffscreenCanvasViewRasterizer()", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "_Future<@>(@)", "bool(@)", "~(@,@)", "0^(0^,0^)<num>", "JavaScriptObject?(double)", "~(String,int)", "~(String,int?)", "int(int,int)", "Uint8List(@,@)", "Future<ServiceExtensionResponse>(String,Map<String,String>)", "Object?(Object?)", "_Channel()", "String()", "String(int)", "Future<~>([JavaScriptObject?])", "Future<Response>(Client)", "bool(String,String)", "int(String)", "FontAsset(@)", "~(List<int>)", "MediaType()", "~(String,String)", "Null(JSArray<Object?>,JavaScriptObject)", "FontFamily(@)", "String(String?)", "String?()", "int(_Line)", "RenderCanvas()", "Object(_Line)", "Object(_Highlight)", "int(_Highlight,_Highlight)", "List<_Line>(MapEntry<Object,List<_Highlight>>)", "SourceSpanWithContext()", "~(NativeUint8List)", "String(String,String)", "~(List<Object?>)", "String?(String)", "String(Object?)", "int(JavaScriptObject)", "HotRestartCacheHandler?()"],
